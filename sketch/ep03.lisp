...
(defsketch ep3-oscillate ((title "Episode 3.1 - Oscillate") (width 400) (height 400) (angle 0))
  (incf angle *speed*)
  (let ((center-y (/ height 2)) (offset (* height 0.4)))
    (circle (/ width 2) (+ center-y (* (sin angle) offset)) *radius*)))
        
(defsketch ep3-grow ((title "Episode 3.2 - Grow") (width 400) (height 400) (angle 0))
  (incf angle *speed*)
  (circle (/ width 2) (/ height 2) (+ *radius* (* 10 (sin angle)))))

(defsketch ep3-fade ((title "Episode 3.3 - Fade") (width 400) (height 400) (angle 0))
  (incf angle *speed*)
